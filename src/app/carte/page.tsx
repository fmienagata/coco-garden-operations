...
export default function MenuPage() {
  ...
  return <main className="menu-shell">
    <header className="menu-header"><div><img className="kitchen-logo" src="/coco-garden-logo.svg" alt={RESTAURANT_NAME} /><p className="eyebrow">{RESTAURANT_NAME} · ADMINISTRATION</p><h1>Gérer la carte</h1></div></header>
