...
export default function DeliveryPage() {
  ...
  return <main className="delivery-shell">
    <header className="delivery-header"><div><img className="kitchen-logo" src="/coco-garden-logo.svg" alt={RESTAURANT_NAME} /><p className="eyebrow">{RESTAURANT_NAME} · LIVRAISON</p><h1>Suivi des livraisons</h1><p className="muted">Les livreurs ne se connectent pas à l’application. Le management gère leur disponibilité et leur envoie les notifications.</p></div></header>
