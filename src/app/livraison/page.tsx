...
export default function DeliveryPage() {
  ...
  return <main className="delivery-shell">
    <header className="delivery-header"><div><img className="kitchen-logo" src="/coco-garden-logo.svg" alt={RESTAURANT_NAME} /><p className="eyebrow">{RESTAURANT_NAME} · LIVRAISON</p><h1>Suivi des livraisons</h1><p className="muted">Le management inscrit les livreurs, configure les zones et envoie les notifications.</p></div><div className="header-actions"><button className="secondary-button" onClick={() => router.push('/notifications')}>Notifications</button><button className="secondary-button" onClick={() => router.push('/cuisine')}>Poste cuisine</button><button className="secondary-button" onClick={logout}>Se déconnecter</button></div></header>
